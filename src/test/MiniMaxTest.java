...
public class MiniMaxTest {
    ...
    public void testOpeningDepth4BlackMovesFirst() {
        ...
        assertEquals(bestMove, MoveFactory.createMove(board, BoardTest.getPieceAtPosition(board, "e7"), BoardUtils.getCoordinateAtPosition("e7"), BoardUtils.getCoordinateAtPosition("e5")));
    }
    ...
    public void advancedLevelProblem2NakamuraShirov() {
        ...
        final Move bestMove = alphaBeta.execute(board);
        assertEquals(bestMove, MoveFactory.createMove(board, BoardTest.getPieceAtPosition(board, "d5"), BoardUtils.getCoordinateAtPosition("d5"), BoardUtils.getCoordinateAtPosition("c7")));
    }

    @Test
    public void testQualityTwoDepth6() {
        final Board board = FenUtilities.parseFEN("6k1/3b3r/1p1p4/p1n2p2/1PPNpP1q/P3Q1p1/1R1RB1P1/5K2 b - - 0 1");
        final MiniMax alphaBeta = new MiniMax(6);
        final Move bestMove = alphaBeta.execute(board);
        assertEquals(bestMove, MoveFactory.createMove(board, BoardTest.getPieceAtPosition(board, "h4"), BoardUtils.getCoordinateAtPosition("h4"), BoardUtils.getCoordinateAtPosition("f4")));
    }

    @Test
    public void testQualityThreeDepth6() {
        final Board board = FenUtilities.parseFEN("r2r1n2/pp2bk2/2p1p2p/3q4/3PN1QP/2P3R1/P4PP1/5RK1 w - - 0 1");
        final MiniMax alphaBeta = new MiniMax(7);
        final Move bestMove = alphaBeta.execute(board);
        assertEquals(bestMove, MoveFactory.createMove(board, BoardTest.getPieceAtPosition(board, "g4"), BoardUtils.getCoordinateAtPosition("g4"), BoardUtils.getCoordinateAtPosition("g7")));
    }

    @Test
    public void testQualityFourDepth6() {
        final Board board = FenUtilities.parseFEN("r1b1k2r/pp3pbp/1qn1p1p1/2pnP3/3p1PP1/1P1P1NBP/P1P5/RN1QKB1R b KQkq - 2 11");
        final MiniMax alphaBeta = new MiniMax(6);
        final Move bestMove = alphaBeta.execute(board);
        assertEquals(bestMove, MoveFactory.createMove(board, BoardTest.getPieceAtPosition(board, "e8"), BoardUtils.getCoordinateAtPosition("e8"), BoardUtils.getCoordinateAtPosition("g8")));
    }
    ...
    public void eloTest2() {
        ...
        final Move bestMove = alphaBeta.execute(board);
        assertEquals(bestMove, MoveFactory.createMove(board, BoardTest.getPieceAtPosition(board, "h5"), BoardUtils.getCoordinateAtPosition("h5"), BoardUtils.getCoordinateAtPosition("g6")));
    }
    ...
    public void eloTest3() {
        ...
        final MiniMax alphaBeta = new MiniMax(6);
        final Move bestMove = alphaBeta.execute(board);
        assertEquals(bestMove, MoveFactory.createMove(board, BoardTest.getPieceAtPosition(board, "g3"), BoardUtils.getCoordinateAtPosition("g3"), BoardUtils.getCoordinateAtPosition("g6")));
    }

    @Test
    public void blackWidowLoss1() {
        final Board board = FenUtilities.parseFEN("r2qkb1r/3p1pp1/p1n1p2p/1p1bP3/P2p4/1PP5/5PPP/RNBQNRK1 w kq - 0 13");
        final MiniMax alphaBeta = new MiniMax(6);
        final Move bestMove = alphaBeta.execute(board);
        assertEquals(bestMove, MoveFactory.createMove(board, BoardTest.getPieceAtPosition(board, "c3"), BoardUtils.getCoordinateAtPosition("c3"), BoardUtils.getCoordinateAtPosition("d4")));
    }
    ...
    public void testCheckmateHorizon() {
        ...
        final MiniMax alphaBeta = new MiniMax(4);
        final Move bestMove = alphaBeta.execute(board);
        assertEquals(bestMove, MoveFactory.createMove(board, BoardTest.getPieceAtPosition(board, "g2"), BoardUtils.getCoordinateAtPosition("g2"), BoardUtils.getCoordinateAtPosition("g4")));
    }
    ...
    public void testBlackInTrouble() {
        ...
        final MiniMax alphaBeta = new MiniMax(4);
        final Move bestMove = alphaBeta.execute(board);
        assertEquals(bestMove, MoveFactory.createMove(board, BoardTest.getPieceAtPosition(board, "e4"), BoardUtils.getCoordinateAtPosition("e4"), BoardUtils.getCoordinateAtPosition("e8")));
    }

    @Test
    public void findMate3() {
        final Board board = FenUtilities.parseFEN("5rk1/5Npp/8/3Q4/8/8/8/7K w - - 0");
        final MiniMax alphaBeta = new MiniMax(6);
        final Move bestMove = alphaBeta.execute(board);
        assertEquals(bestMove, MoveFactory.createMove(board, BoardTest.getPieceAtPosition(board, "f7"), BoardUtils.getCoordinateAtPosition("f7"), BoardUtils.getCoordinateAtPosition("h6")));
    ...
    public void runawayPawnMakesIt() {
        final Board board = FenUtilities.parseFEN("2k5/8/8/8/p7/8/8/4K3 b - - 0 1");
        final MiniMax alphaBeta = new MiniMax(5);
        final Move bestMove = alphaBeta.execute(board);
        assertEquals(bestMove, MoveFactory.createMove(board, BoardTest.getPieceAtPosition(board, "a4"), BoardUtils.getCoordinateAtPosition("a4"), BoardUtils.getCoordinateAtPosition("a3")));
        final MoveTransition t1 = board.currentPlayer().makeMove(bestMove);
        assertTrue(t1.getMoveStatus().isDone());
    }
    ...
    public void testMackHackScenario() {
        final Board board = FenUtilities.parseFEN("1r1k1r2/p5Q1/2p3p1/8/1q1p2n1/3P2P1/P3RPP1/4RK2 b - - 0 1");
        final MiniMax alphaBeta = new MiniMax(8);
        final Move bestMove = alphaBeta.execute(board);
        assertEquals(bestMove, MoveFactory.createMove(board, BoardTest.getPieceAtPosition(board, "f8"), BoardUtils.getCoordinateAtPosition("f8"), BoardUtils.getCoordinateAtPosition("f2")));
        final MoveTransition t1 = board.currentPlayer().makeMove(bestMove);
        assertTrue(t1.getMoveStatus().isDone());
    }
    ...
    public void testAutoResponseVsPrinChess() {
        final Board board = FenUtilities.parseFEN("r2q1rk1/p1p2pp1/3p1b2/2p2QNb/4PB1P/6R1/PPPR4/2K5 b - - 0 1");
        final MiniMax alphaBeta = new MiniMax(6);
        final Move bestMove = alphaBeta.execute(board);
        assertEquals(bestMove, MoveFactory.createMove(board, BoardTest.getPieceAtPosition(board, "h5"), BoardUtils.getCoordinateAtPosition("h5"), BoardUtils.getCoordinateAtPosition("g6")));
        final MoveTransition t1 = board.currentPlayer().makeMove(bestMove);
    ...
    public void testBratcoKopec1() {
        final Board board = FenUtilities.parseFEN("1k1r4/pp1b1R2/3q2pp/4p3/2B5/4Q3/PPP2B2/2K5 b - - 0 1");
        final MiniMax alphaBeta = new MiniMax(6);
        final Move bestMove = alphaBeta.execute(board);
