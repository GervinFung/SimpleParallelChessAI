...
public final class StaleMateTest {
    ...
    public void testAnandKramnikStaleMate() {
        ...
        final MoveTransition t1 = board.currentPlayer().makeMove(MoveFactory.createMove(board, BoardTest.getPieceAtPosition(board, "e4"), BoardUtils.getCoordinateAtPosition("e4"), BoardUtils.getCoordinateAtPosition("f5")));
    ...
    public void testAnonymousStaleMate() {
        ...
        final Board board = builder.build();
        assertFalse(board.currentPlayer().isInStalemate());
        final MoveTransition t1 = board.currentPlayer().makeMove(MoveFactory.createMove(board, BoardTest.getPieceAtPosition(board, "c5"), BoardUtils.getCoordinateAtPosition("c5"), BoardUtils.getCoordinateAtPosition("c6")));
        assertTrue(t1.getMoveStatus().isDone());
        assertTrue(t1.getLatestBoard().currentPlayer().isInStalemate());
        assertFalse(t1.getLatestBoard().currentPlayer().isInCheck());
        assertFalse(t1.getLatestBoard().currentPlayer().isInCheckmate());
    ...
    public void testAnonymousStaleMate2() {
        ...
        final Board board = builder.build();
        assertFalse(board.currentPlayer().isInStalemate());
        final MoveTransition t1 = board.currentPlayer().makeMove(MoveFactory.createMove(board, BoardTest.getPieceAtPosition(board, "a6"), BoardUtils.getCoordinateAtPosition("a6"), BoardUtils.getCoordinateAtPosition("a7")));
        assertTrue(t1.getMoveStatus().isDone());
        assertTrue(t1.getLatestBoard().currentPlayer().isInStalemate());
        assertFalse(t1.getLatestBoard().currentPlayer().isInCheck());
        assertFalse(t1.getLatestBoard().currentPlayer().isInCheckmate());
